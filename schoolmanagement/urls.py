...
urlpatterns = [
    ...
    path('studentwaitapproval', views.studentwaitapproval,name='student-approval-wait'),
    path('teacherwaitapproval', views.teacherwait_approval,name='teacher-approval-wait'),
    ...
    path('delete-message-from-database/<int:pk>', views.delete_message_from_database, name='delete-message-from-database'),
    path('update-teacher/<int:pk>', views.update_teacher_view,name='update-teacher'),
    path('admin-view-teacher-salary', views.admin_view_teacher_salary_view,name='admin-view-teacher-salary'),
    path('admin-message', views.admin_message_view, name='admin-message'),
